<template>
  <div class="py-12 bg-white" v-if="!pending && postContent">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative " :class="{
      'top-56 sm:top-72 md:top-96 xl:top-0':
        postContent.image
    }">
      <h2 class="text-base text-yellow-300 font-semibold tracking-wide uppercase relative">{{ postContent.description }}
      </h2>
      <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">{{ postContent.title }}
      </p>
